...
const HistorialConsumos = () => {
    const { data } = useGetData(['historial/consumo']);console.log(data)

    const columns = ['Código', 'Documento', 'Nombre', 'Elemento', 'Descripcion', 'Cantidad', 'Observaciones', 'Estado', 'Acción', 'Fecha', 'Admin'];
